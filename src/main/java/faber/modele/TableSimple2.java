...
import faber.modele.listener.ListenerTableMouseMotion2;
import faber.modele.renderer.HeaderRenderer;
import faber.modele.renderer.Rendu2;
 ...
 * @author guillaume
 */
public class TableSimple2 extends Table {
    ...
    private ModeleTableSimple2 modeleTableSimple2;
    protected MouseAdapter mouseAdapter;
    protected ArrayList<Integer> collectionNumeroColonne = new ArrayList<Integer>();
    public TableSimple2(Integer hauteurLigne, Color couleurFond, Color couleurPolice, int nombreBoutonAction, boolean selectCell, ModeleDonnees modeleDonnees) {
        ...
        modeleTableSimple2 = modeleDonnees.getModeleTable();
        modeleDonnees.setTable(this);
        init();
    }
    ...
    public void mettreAJourTable() {
        modeleTableSimple2.fireTableDataChanged();
    }

    public void addIcone(int numeroColonne, Rendu2 rendu) {
        this.getColumnModel().getColumn(numeroColonne).setCellRenderer(rendu);
        this.collectionNumeroColonne.add(numeroColonne);
    }

    public ModeleTableSimple2 getModeleTableSimple2() {
        return modeleTableSimple2;
    }

    public void init() {
        this.setModel(modeleTableSimple2);
        this.initaliserColonne(modeleTableSimple2);
        ListenerTableMouseMotion2 listenerTableMouseMotion2 = new ListenerTableMouseMotion2(modeleDonnees,this,collectionNumeroColonne);
        this.addMouseMotionListener(listenerTableMouseMotion2);
    }
    public void initaliserColonne(ModeleTableSimple2 tableModel) {
        TableColumn col;
        TableColumnModel tableColumnModel = this.getColumnModel();
        ArrayList<faber.modele.ColonneTable> CollectionChamp = tableModel.getCollectionChamps();
    ...
    public TableSimple2(ArrayList<ColonneTable> listeColonne, Integer hauteurLigne) {
     ...
     * @param columnNames names of each column
     */
    public TableSimple2(final Object[][] rowData, final Object[] columnNames) {
    ...
    public TableSimple2(Integer hauteurLigne) {
