...
public class Rendu extends DefaultTableCellRenderer {
    ...
    public Rendu(String texteAfficher, ImageIcon icon, Donnees donnees) {
    ...
    public Component getTableCellRendererComponent(JTable table, Object value, boolean isSelected, boolean hasFocus, int row, int column) {
        ...
        InterfaceDonnees interfaceCollection = donnees.get(row);

        if (interfaceCollection.afficherIconePointeurMain(column)) {
            this.setIcon(icon);
