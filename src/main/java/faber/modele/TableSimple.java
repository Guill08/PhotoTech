 ...
 * @author guillaume
 */
public class TableSimple extends Table {
    ...
    public TableSimple(Integer hauteurLigne, Color couleurFond, Color couleurPolice, int nombreBoutonAction, boolean selectCell, DonneesSimple donneesSimple) {
    ...
    public DonneesSimple getDonneesSimple() {
        return donneesSimple;
    }

    public void setDonneesSimple(DonneesSimple donneesSimple) {
        this.donneesSimple = donneesSimple;
        modeleTable = donneesSimple.getModeleTable();
    }

    public ModeleTableSimple getModeleTableSimple2() {
        return modeleTable;
    }
    ...
    public TableSimple(ArrayList<ColonneTable> listeColonne, Integer hauteurLigne) {
     ...
     * @param columnNames names of each column
     */
    public TableSimple(final Object[][] rowData, final Object[] columnNames) {
    ...
    public TableSimple(Integer hauteurLigne) {
